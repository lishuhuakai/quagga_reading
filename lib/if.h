...
#define ZEBRA_IFC_QUEUED       (1 << 2)
    /*
       ...
       ZEBRA_IFC_QUEUED标记仅当此地址在kernel中存在，但是它可能还不能使用
     */
...
#define ZEBRA_IFA_UNNUMBERED   (1 << 2)
     ...
     * 对端或者一个广播地址,取决于ZEBRA_IFA_PEER标记是否设定了。
     */
